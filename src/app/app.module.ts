...
import { StatsSummaryComponent } from './components/stats/stats.component';
import { MakeClickableDirective } from './directives/clickable.directive';
...
@NgModule({
  declarations: [
    AppComponent, LoadingComponent, StatsSummaryComponent, MakeClickableDirective
  ],
